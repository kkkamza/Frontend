...
import { Container, Typography, Grid, Card, CardContent, Button, TextField, Box, Rating, Tabs, Tab } from '@mui/material';
...
const StoreDetailPage = () => {
  ...
  const handleReviewSubmit = async () => {
    try {
      const response = await fetch(`/store/${storeId}/review`, { // fetch URL 수정
        method: 'POST',
        headers: {
